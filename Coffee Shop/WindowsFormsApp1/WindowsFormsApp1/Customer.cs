    ...
    public partial class Customer : Form
    {
        ...
        private void addvalue1()
        {
            try
            {
                ...
                //command
                string commandstring = @"INSERT INTO Item(Name,Price)VALUES('" + nameTextBox.Text + "'," + addressnoTextBox.Text + ")";
        ...
        private void update1()
        {
            try
            {
                ...
                SqlConnection sqlconnection = new SqlConnection(connectionstring);
                //command
                string commandstring = @"UPDATE Item SET Name='" + nameTextBox.Text + "',Price=" + addressnoTextBox.Text + " WHERE Id=" + idTextBox.Text + "";
                SqlCommand sqlcommand = new SqlCommand(commandstring, sqlconnection);
